...
function renderTopbarR(){
  ...
  if(VIEW==='budget') h+='<button class="btn soft" onclick="triggerWBSImport()" title="Import WBS hierarchy from Excel">&#128196; Import WBS</button>';
  /* Worker import */
...
function openSettingsModal(){
  ...
  h+='</div></div>';
  h+='<div style="margin:12px 0;padding-top:12px;border-top:1px solid var(--border2)"><button class="btn soft" onclick="closeModal();setTimeout(function(){openModal(\\"companies\\")},100)" style="font-size:11px">&#127970; Manage Companies</button></div>';
