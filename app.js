...
function wbsCCRows(w,lv,page){
  ...
  if(hasSubRows){
    ...
    for(var m=0;m<NM;m++){
      ...
      h+='<td class="'+cls+(_edT?' edt':'')+' num" style="'+bl+'border-right:1px solid var(--border);background:#f0f4f8;vertical-align:top;padding:2px 4px'+(_edT?';cursor:pointer':'')+'"'+(  _edT?' onclick="ecCC(this,\''+wid+'\','+m+',\'rad\',' +avT+')"':'')+'>';
