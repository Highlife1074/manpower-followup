...
function renderAssignmentsPage(){
  ...
  html += '<button class="btn" style="font-size:11px;display:' + (totalSel>0?'inline-flex':'none') + ';color:var(--blue);border-color:var(--blue)" onclick="openPositionDialog()">&#9711; Open Pos.</button>';
