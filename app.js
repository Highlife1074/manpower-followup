...
function ccHead(page){
  ...
  h+='<th colspan="4" style="text-align:left;padding:4px 10px;border-right:'+SEP+'">WBS &amp; Budget</th>';
  h+='<th colspan="3" style="text-align:center;padding:4px 10px;border-right:'+SEP+'">Month</th>';
  h+='<th colspan="3" style="text-align:center;padding:4px 10px;border-right:'+SEP+'">Cumulated</th>';
  h+='<th colspan="3" style="text-align:center;padding:4px 10px;border-right:'+SEP+'">EOS</th>';
  for(var m=0;m<NM;m++){
    var lbl=ML[m]?ML[m].short:'';
    var isCur=(m===page);
    var bg=isCur?'rgba(78,69,128,.15)':'';
    var col=isCur?'var(--pur)':'#475569';
    h+='<th style="text-align:center;'+(bg?'background:'+bg+';':'')+';color:'+col+';border-right:'+SEP+';padding:4px 6px;font-size:10px;font-weight:700">'+lbl+(m===S.ccM?' ●':'')+'</th>';
  }
  h+='</tr>';
  ...
  h+='<th style="min-width:60px;border-right:'+SEP+'">Total Bud</th>';
  h+='<th style="min-width:52px;border-right:1px solid var(--border2)">Bud M</th>';
  h+='<th style="min-width:52px;border-right:1px solid var(--border2)">Cost M</th>';
  h+='<th style="min-width:50px;border-right:'+SEP+'">Var M</th>';
  h+='<th style="min-width:52px;border-right:1px solid var(--border2)">Cum Bud</th>';
  h+='<th style="min-width:52px;border-right:1px solid var(--border2)">Cum Cost</th>';
  h+='<th style="min-width:50px;border-right:'+SEP+'">Cum Var</th>';
  h+='<th style="min-width:52px;border-right:1px solid var(--border2)">EAC</th>';
  h+='<th style="min-width:50px;border-right:1px solid var(--border2)">Var EAC</th>';
  h+='<th style="min-width:50px;border-right:'+SEP+'">Var EOS</th>';
  for(var m=0;m<NM;m++){
    ...
    h+='<th style="font-size:9px;font-weight:700;color:var(--tx2);'+(bg?'background:'+bg+';':'')+bl+'border-right:'+SEP+';min-width:70px;padding:3px 4px">HM / EUR</th>';
  }
  h+='</tr>';
  return h;
}
...
function ccGrpRow(g,allW,page){
  ...
  var tVarM=+(tBM-tCostM).toFixed(1),tCumVar=+(tCumBud-tRC).toFixed(1),tVarEOS=+(tB-tEAC).toFixed(1),tVarEAC=+(tCumBud-tRC).toFixed(1);
  ...
  h+='<td class="p2" style="border-right:1px solid var(--border2)"></td>';
  h+='<td class="p3" style="border-right:1px solid var(--border2)"></td>';
  h+='<td class="num" style="border-right:'+SEP+';color:var(--blue)">'+(tB?tB.toFixed(1):'')+'</td>';
  ...
  h+='<td class="num '+pncBC(tVarM)+'" style="font-weight:800;border-right:'+SEP+'">'+(tB>0||tCostM>0?(tVarM>0?'+':'')+tVarM.toFixed(1):'')+'</td>';
  ...
  h+='<td class="num '+pncBC(tCumVar)+'" style="font-weight:800;border-right:'+SEP+'">'+(tCumBud>0||tRC>0?(tCumVar>0?'+':'')+tCumVar.toFixed(1):'')+'</td>';
  h+='<td class="num" style="border-right:1px solid var(--border2)">'+(tEAC?tEAC.toFixed(1):'')+'</td>';
  h+='<td class="num '+pncBC(tVarEAC)+'" style="border-right:1px solid var(--border2)">'+(tB>0||tRC>0?(tVarEAC>0?'+':'')+tVarEAC.toFixed(1):'')+'</td>';
  h+='<td class="num '+pncBC(tVarEOS)+'" style="font-weight:800;border-right:'+SEP+'">'+(tB>0||tEAC>0?(tVarEOS>0?'+':'')+tVarEOS.toFixed(1):'')+'</td>';
  for(var m=0;m<NM;m++){
    ...
    var isCurM=(m===page); var bl=isCurM?'border-left:2px solid var(--pur);':'';
    h+='<td class="num '+(m<page?'col-past-td':m===page?'col-cur-td':'col-rad-td')+'" style="'+bl+'border-right:'+SEP+';vertical-align:top;padding:2px 4px">'
      +'<div style="color:var(--blue);font-size:10px">'+(mB?mB.toFixed(1):'')+'</div>'
      +'<div style="color:var(--green);font-size:10px">'+(mC?mC.toFixed(1):'')+'</div>'
...
function ccSgRow(sg,sgW,page){
  ...
  h+='<td class="p2" style="border-right:1px solid var(--border2)"></td>';
  h+='<td class="p3" style="border-right:1px solid var(--border2)"></td>';
  h+='<td class="num" style="border-right:'+SEP+'">'+(tB?tB.toFixed(1):'')+'</td>';
  ...
  h+='<td class="num '+pncBC(tVarM)+'" style="font-weight:700;border-right:'+SEP+'">'+(tB>0||tCostM>0?(tVarM>0?'+':'')+tVarM.toFixed(1):'')+'</td>';
  h+='<td class="num" style="border-right:1px solid var(--border2)">'+(tCumBud?tCumBud.toFixed(1):'')+'</td>';
  h+='<td class="num" style="border-right:1px solid var(--border2)">'+(tRC?tRC.toFixed(1):'')+'</td>';
  h+='<td class="num '+pncBC(tCumVar)+'" style="font-weight:700;border-right:'+SEP+'">'+(tCumBud>0||tRC>0?(tCumVar>0?'+':'')+tCumVar.toFixed(1):'')+'</td>';
  h+='<td class="num" style="border-right:1px solid var(--border2)">'+(tEAC?tEAC.toFixed(1):'')+'</td>';
  h+='<td class="num" style="border-right:1px solid var(--border2)"></td>';
  h+='<td class="num '+pncBC(tVarEOS)+'" style="font-weight:700;border-right:'+SEP+'">'+(tB>0||tEAC>0?(tVarEOS>0?'+':'')+tVarEOS.toFixed(1):'')+'</td>';
  for(var m=0;m<NM;m++){
    ...
    h+='<td class="num '+(m<page?'col-past-td':m===page?'col-cur-td':'col-rad-td')+'" style="'+bl+'border-right:'+SEP+';vertical-align:top;padding:2px 4px">'
      +'<div style="color:var(--blue);font-size:10px">'+(mB?mB.toFixed(1):'')+'</div>'
      +'<div style="color:var(--green);font-size:10px">'+(mC?mC.toFixed(1):'')+'</div>'
      +'<div style="color:'+vC+';font-weight:700;font-size:10px">'+(mB>0||mC>0?(mVar>0?'+':'')+mVar.toFixed(1):'')+'</div>'
      +'</td>';
  }
  h+='</tr>';
  return h;
...
function ccBody(page){
  ...
  for(var gi=0;gi<S.groups.length;gi++){
    ...
    if(g.col){h+='<tr class="wbs-sep-row"><td colspan="'+(13+NM)+'"></td></tr>';continue;}
    ...
    h+='<tr style="height:4px"><td colspan="'+(13+NM)+'" style="background:var(--bg);border-top:3px solid #8a8070"></td></tr>';
  }
  return h;
}
...
function wbsCCRows(w,lv,page){
  ...
  var varEAC=+(cumBud-rc2).toFixed(1);
  var varEOS=+(bt-eac).toFixed(1);
  var wid=w.id;
  ...
  /* ── Row 1: Budget HM ── */
  h+='<tr class="rwbs '+alt+'">';
  h+='<td class="p1" style="padding-left:'+ind+'px;border-right:1px solid var(--border2)" rowspan="3">';
  if(w.code)h+='<span class="codb">'+w.code+'</span> ';
  ...
  /* Fixed summary cols — only on budget row */
  h+='<td class="num" style="border-right:'+SEP+';color:var(--blue)" rowspan="3">'+(bt?bt.toFixed(1):'')+'</td>';
  ...
  h+='<td class="num" style="border-right:1px solid var(--border2)"></td>';
  h+='<td class="num" style="border-right:'+SEP+'"></td>';
  h+='<td class="num" style="border-right:1px solid var(--border2)">'+(eac>0?eac.toFixed(1):'')+'</td>';
  h+='<td class="num" style="border-right:1px solid var(--border2)"></td>';
  h+='<td class="num '+pncBC(varEOS)+'" style="font-weight:800;border-right:'+SEP+'">'+(bt>0||eac>0?(varEOS>0?'+':'')+varEOS.toFixed(1):'')+'</td>';
  /* Budget HM monthly */
  for(var m=0;m<NM;m++){
    ...
    h+='<td class="'+cls+' num" style="'+bl+'border-right:'+SEP+';vertical-align:top;padding:2px 4px">';
    h+='<div style="color:var(--blue);font-size:10px">'+(bv?bv.toFixed(1):'')+'</div>';
    h+='<div style="color:#1d4ed8;font-size:9px">'+(bEur?fkv(bEur):'')+'</div>';
    h+='</td>';
  }
  h+='</tr>';
  ...
  h+='<td class="num '+pncBC(varM)+'" style="font-weight:700;border-right:'+SEP+'">'+(bt>0||costM>0?(varM>0?'+':'')+varM.toFixed(1):'')+'</td>';
  h+='<td class="num" style="border-right:1px solid var(--border2);color:var(--green)">'+(rc2?rc2.toFixed(1):'')+'</td>';
  h+='<td class="num '+pncBC(cumVar)+'" style="font-weight:700;border-right:'+SEP+'">'+(cumBud>0||rc2>0?(cumVar>0?'+':'')+cumVar.toFixed(1):'')+'</td>';
  h+='<td class="num" style="border-right:1px solid var(--border2)"></td>';
  h+='<td class="num '+pncBC(varEAC)+'" style="border-right:1px solid var(--border2)">'+(bt>0||rc2>0?(varEAC>0?'+':'')+varEAC.toFixed(1):'')+'</td>';
  ...
  for(var m=0;m<NM;m++){
    ...
    var avStyle=m===page?'color:var(--pur);font-weight:700':m<S.ccM?'color:var(--tx2)':'color:var(--tx2);font-style:italic';
    var hasMR2=m>S.ccM&&ccSlot(m).rad[w.id]!==undefined;
    if(hasMR2) avStyle='color:#c2410c;font-weight:700';
    var delta=hasMR2?+(av-reelHMFromAssign(w.id,m)).toFixed(1):0;
    var dStr=delta!==0?'<span style="font-size:8px;color:'+(delta>0?'#15803d':'#b91c1c')+'"> ('+(delta>0?'+':'')+delta+')</span>':'';
    h+='<td class="'+cls+(m>=S.ccM&&!_lk?' edt':'')+' num" style="'+bl+'border-right:'+SEP+';vertical-align:top;padding:2px 4px"'+(m>=S.ccM&&!_lk?' onclick="ecCC(this,\''+wid+'\','+m+',\'rad\','+av+')"':'')+'>';
    h+='<div style="'+avStyle+';font-size:10px;cursor:'+(m>=S.ccM&&!_lk?'pointer':'default')+'">'+av.toFixed(1)+dStr+'</div>';
    h+='<div style="color:#15803d;font-size:9px">'+(avEur?fkv(avEur):'')+'</div>';
    h+='</td>';
  }
  h+='</tr>';
  ...
  for(var m=0;m<NM;m++){
    var bv=bud(w,m);
    var rv=m<=S.ccM?reel(w,m):(ccSlot(m).rad[w.id]!==undefined?+ccSlot(m).rad[w.id]:reelHMFromAssign(w.id,m));
    var varHM=+(bv-rv).toFixed(1);
    var cls=m<page?'col-past-td':m===page?'col-cur-td':'col-rad-td';
    var bl=m===page?'border-left:2px solid var(--pur);':'';
    h+='<td class="'+cls+' num '+pncBC(varHM)+'" style="'+bl+'font-weight:700;border-right:'+SEP+';font-size:10px">'+(bv>0||rv>0?(varHM>0?'+':'')+varHM.toFixed(1):'')+'</td>';
  }
  h+='</tr>';

  /* Separator */
  h+='<tr class="wbs-sep-row"><td colspan="'+(13+NM)+'"></td></tr>';
  ...
  (w.subcontracts||[]).forEach(function(sc){
    ...
    h+='<tr class="'+alt+'"><td class="p1" colspan="13" style="padding:2px 6px 2px '+(ind+10)+'px;border-right:'+SEP+';background:#eff6ff;font-size:10px;color:var(--blue)">';
    ...
    for(var m=0;m<NM;m++){
      ...
      h+='<td class="'+cls2+(!_lk&&!_past?' edt':'')+' num" style="border-right:'+SEP+';font-size:10px;color:var(--blue);'+ (!_lk&&!_past?'cursor:pointer':'')+ '"'
  ...
  (S.contracts||[]).filter(function(ct){return ct.wbsId===wid;}).forEach(function(ct){
    ...
    var alertBadge=_cOver?'<span style="background:#fee2e2;color:#b91c1c;font-weight:700;padding:1px 6px;border-radius:4px;margin-left:6px">⚠ +'+fkv(_cProj-_ctBud)+'€</span>'
    ...
    h+='<tr class="'+alt+'"><td class="p1" colspan="13" style="padding:2px 6px 2px '+(ind+10)+'px;border-right:'+SEP+';background:#faf5ff;font-size:10px;color:var(--pur)">';
    h+='&#128196; <strong>'+ct.ref+'</strong>'+(ct.company?' — '+ct.company:'');
    if(_ctBud)h+=' &nbsp;·&nbsp; Bud: '+fkv(_ctBud)+'€';
    h+=' &nbsp;·&nbsp; Dép: '+fkv(_cSpent)+'€'+alertBadge;
    h+='</td>';
    for(var m=0;m<NM;m++){
      if(!contractMonthActive(ct,m)){h+='<td style="border-right:'+SEP+'"></td>';continue;}
