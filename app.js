...
function ccHead(page){
  /* Fixed columns + monthly groups (Budget HM | EUR | Var) */
  var h='<tr style="background:var(--bg2);position:sticky;top:0;z-index:15">';
  ...
  h+='<th class="p4" style="min-width:62px;border-right:1px solid var(--border2)">Total Bud</th>';
  ...
  h+='<th style="min-width:52px;border-right:1px solid var(--border2)">Var M</th>';
  ...
  h+='<th style="min-width:52px;border-right:1px solid var(--border2)">Cum Var</th>';
  ...
  h+='<th style="min-width:52px;border-right:2px solid var(--border3)">Var EOS</th>';
...
function wbsCCRows(w,lv,page,isLast){
  ...
  h+='<td class="num p4" style="border-right:1px solid var(--border2);color:var(--blue)">'+(bt?bt.toFixed(1):'')+'</td>';
  ...
  h+='<td class="num '+pnF(varM)+'" style="border-right:1px solid var(--border2);font-weight:700">'+(bt>0||costM>0?(varM>0?'+':'')+varM.toFixed(1):'')+'</td>';
  ...
  h+='<td class="num '+pnF(cumVar)+'" style="border-right:1px solid var(--border2);font-weight:700">'+(cumBud>0||rc2>0?(cumVar>0?'+':'')+cumVar.toFixed(1):'')+'</td>';
  h+='<td class="num" style="border-right:1px solid var(--border2);color:var(--tx2)">'+(eac?eac.toFixed(1):'')+'</td>';
  h+='<td class="num '+pnF(varEAC)+'" style="border-right:1px solid var(--border2);font-weight:700">'+(bt>0?(varEAC>0?'+':'')+varEAC.toFixed(1):'')+'</td>';
  h+='<td class="num '+pnF(varEOS)+'" style="border-right:2px solid var(--border3);font-weight:800">'+(bt>0?(varEOS>0?'+':'')+varEOS.toFixed(1):'')+'</td>';
  ...
  for(var m=0;m<NM;m++){
    ...
    h+='<td style="text-align:right;padding:3px 4px;font-family:var(--mono);font-size:10px;'+bl+bg+';border-right:1px solid var(--border)">'+hmContent+'</td>';
    h+='<td style="text-align:right;padding:3px 4px;font-family:var(--mono);font-size:9px;border-right:1px solid var(--border)">'+(budEurM&&_showEurRows?fkv(budEurM):'<span style="color:#1d4ed8;font-size:9px">'+(budEurM?fkv(budEurM):'')+'</span>')+'</td>';
    h+='<td style="text-align:right;padding:3px 4px;font-family:var(--mono);font-size:10px;border-right:2px solid var(--border2);font-weight:700;color:'+varHMcol+'">'+(bv>0||av>0?(varHM>0?'+':'')+varHM.toFixed(1):'')+'</td>';
  }
  h+='</tr>';
