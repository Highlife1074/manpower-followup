...
function wbsCCRows(w,lv,page,isLast){
  ...
  if(w.subcontracts&&w.subcontracts.length>0){
    w.subcontracts.forEach(function(sc){
      ...
      h+='<tr class="'+wbsCls+'"><td class="p1" colspan="8" style="padding:3px 6px 3px '+(ind+12)+'px;border-right:2px solid var(--border2);background:#f0f4ff">';
  ...
  (S.contracts||[]).filter(function(c){return c.wbsId===wid;}).forEach(function(c){
    ...
    h+='<tr class="'+wbsCls+'"><td class="p1" colspan="8" style="padding:3px 6px 3px '+(ind+12)+'px;border-right:2px solid var(--border3);background:#faf5ff">';
