...
function renderCCPage(page){
  ...
  document.getElementById('pageContent').innerHTML=banner+botHtml+tableHtml+invHtml;
}
...
function renderAssignmentsPage(){
  ...
  for(var gi = 0; gi < S.groups.length; gi++){
    ...
    _grH += '<td style="position:sticky;left:220px;z-index:5;background:#d8d2c8;padding:6px 8px;font-family:var(--mono);font-size:11px;font-weight:700;color:#5a524a;text-align:right;border-bottom:2px solid var(--border3);">' + (_gBud ? _gBud.toFixed(1) : '') + '</td>';
    /* month totals */
    for(var m = startCol; m < NM; m++){
    ...
    for(var si = 0; si < g.sub.length; si++){
      ...
      _sgH += '<td style="position:sticky;left:220px;z-index:5;background:#e2ddd4;padding:5px 8px;font-family:var(--mono);font-size:11px;font-weight:700;color:#4a3a80;text-align:right;border-bottom:1px solid var(--border3);">' + (_sgBud ? _sgBud.toFixed(1) : '') + '</td>';
      for(var m = startCol; m < NM; m++){
...
function asWBSRow(wbs, ind, startCol, page, nCols){
  ...
  for(var m = startCol; m < NM; m++){
    ...
    h += '<div class="as-cell" style="min-width:80px;min-height:38px;padding:4px 6px;display:flex;flex-direction:column;align-items:center;justify-content:center;cursor:' + cursorStyle + ';' + alertStyle + '"';
